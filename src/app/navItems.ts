...
import { Home, BookOpen, Puzzle, Swords, ClipboardPaste, Microscope, Trophy } from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Compose',  path: '/compose',   icon: createElement(ClipboardPaste, { size: 16 }), blurb: 'Paste a PGN, import a Lichess/Chess.com game, or free-play from any position' },
  { label: 'Analyze',  path: '/analyze',   icon: createElement(Microscope, { size: 16 }),     blurb: 'Branch off the loaded game, with engine eval + best move' },
